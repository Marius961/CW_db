...
<div class="info-1 form-group">
    ...
    <form:form action="/search" method="post" modelAttribute="searchedPhone">
        <form:input path="smartPhoneModel" type="text" class="form-control"/>
        <br>
        <form:button class="btn btn-primary">Search</form:button>
    </form:form>
    <a href="<c:url value="/"/>" >Зкинути</a>
</div>
